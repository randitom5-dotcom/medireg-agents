...
export function ChatComposer({
  ...
  return (
    <section className="chat-composer" aria-label="发送注册知识库任务">
      {uploadedItems.length > 0 ? (
        <div className="attachment-strip" aria-label="当前会话资料">
      ...
      {hasStagedFiles ? (
        <div className="attachment-strip" aria-label="待上传附件">
          ...
          {isUploading ? <span className="attachment-uploading">上传中...</span> : null}
        </div>
      ) : null}
      ...
      <div className="composer-shell">
        <textarea
          ...
          placeholder="输入医疗器械注册问题，例如：查询某类产品临床评价路径，并给出引用来源..."
          value={query}
        />
