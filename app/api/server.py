...
from app.api.v1.routes import router as integration_v1_router
...
app = FastAPI(title="MediReg Agents API", lifespan=lifespan)
app.include_router(integration_v1_router)
